...
from on_secondaries.comparison_Cheng2018.Cheng2018_simulations import trace_options
...
def receiver_position_error_range_analysis(lfc: lfc_optic, site_data: SiteData,
    ...
    low_displacements = [-50., -15., 15., 50.]
    displacements = linspace(start=-20, stop=20, num=11) * 10
    high_displacements = [-250., 250.]

    displacement_values = array(list(set(low_displacements + displacements.tolist() + high_displacements)))
...
lfc_optics = [cheng_lfc, cheng_cpc, cheng_cec]


for lfc_concentrator in lfc_optics:
    dx_data, dy_data = receiver_position_error_range_analysis(lfc=lfc_concentrator, site_data=cheng_loc,
