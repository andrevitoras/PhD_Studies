...
from numpy import ones, arange, absolute, zeros
...
from solaren.scopy.linear_fresnel import PrimaryField, Absorber, uniform_centers, acceptance_angle, PrimaryMirror
